...
class LibrarySystemTest {
    ...
    @Test
    void TC1_addBook(){
        assertEquals(sample.addBook("Percy Jackson","Rick","fantasy",2012,"sample text"),"Book added successfully: Percy Jackson");
    }

    @Test
    void TC2_addBook(){
        assertEquals(sample.addBook("Lord of the Rings","Tolkien","fantasy",1940,"sample text again"),"Book added successfully: Lord of the Rings");
    }
